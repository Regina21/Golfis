...
users = ["djokernole", "RafaelNadal" "ThiemDomi", "rogerfederer", "keinishikori", "KAndersonATP",
		"delpotrojuan", "JohnIsner", "StefsTsitsipas", "cilic_marin",
		"Naomi_Osaka_", "Simona_Halep", "Petra_Kvitova", "KaPliskova",
		"AngeliqueKerber", "ElinaSvitolina", "kikibertens", "SloaneStepehns",
